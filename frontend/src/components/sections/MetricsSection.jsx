...
import { FaCog, FaTrophy, FaUsers } from "react-icons/fa"; // Import icons from react-icons
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-[#2D2F36] p-6 rounded-lg shadow-lg text-center border-2 border-transparent transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-[#3A3D46] hover:border-[#DAAA00]">
                        ...
                        <p className="text-[#EBD99F] mt-2 transition-all duration-300 group-hover:text-white">Always designed and constructed by our team</p>
                    </div>
